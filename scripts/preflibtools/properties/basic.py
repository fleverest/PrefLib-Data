...
def borda_scores(instance):
    """ Computes the total Borda scores of all the alternatives of the instance. Within an indifference class, all
        ...
        :rtype: dict
    """
    if instance.data_type not in ("toc", "soc", "toi", "soi"):
...
def sum_vote_count(instance):
    """ Returns the sum of the vote count of the instance.
        ...
        :rtype: int
    """
    return instance.sum_vote_count


def num_different_orders(instance):
